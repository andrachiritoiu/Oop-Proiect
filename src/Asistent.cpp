...
Asistent::Asistent(const std::string &nume, const std::string &prenume, const std::string &CNP, int salariu, int experienta,
        const std::string &program, const std::string &sectie, std::vector<std::string> proceduri_efectuate) : PersonalSpital(nume,
        prenume, CNP, salariu, experienta, program) {
    this->sectie=sectie;
    this->proceduri_efectuate=proceduri_efectuate;
}
//copy constructor
Asistent::Asistent(const Asistent &a): PersonalSpital(nume , prenume, CNP, salariu, experienta, program) {
...
void Asistent :: efectueazaProcedura(Pacient *p, std::string procedura) {
